...
namespace Ntl.AuthSS.OrderManagement.Data.Migrations
{
    ...
    [Migration("20240620091110_TaxslabReflectingFrom")]
    partial class TaxslabReflectingFrom
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ntl.AuthSS.OrderManagement.Data.Entities.OrderPaymentBreakdown", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ItemPriceType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("OrderPaymentBreakdown");
                });
            ...
            modelBuilder.Entity("Ntl.AuthSS.OrderManagement.Data.Entities.Reel", b =>
                {
                    ...
                    b.Property<DateTime?>("FulfillLockedDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsUsedForFulfillment")
                        .HasColumnType("bit");

                    b.Property<Guid?>("LockedOrderItemId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ntl.AuthSS.OrderManagement.Data.Entities.TaxSlab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("ReflectingFrom")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Ntl.AuthSS.OrderManagement.Data.Entities.OrderPaymentBreakdown", b =>
                {
                    b.HasOne("Ntl.AuthSS.OrderManagement.Data.Entities.Order", "Order")
                        .WithMany("OrderPaymentBreakdowns")
                        .HasForeignKey("OrderId");
                });
